...
ENT.PrintName		= "Wasteland Scanner Grenade"
ENT.Author 			= "Warkin"
...
if CLIENT then
	local Name = "Wasteland Scanner Grenade"
	local LangName = "obj_vj_titan_rocket"
...
util.SpriteTrail(self,10,Color(255,255,255),true,10,1,1,12/(10+10)*10,"sprites/smoke.vmt")
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:DeathEffects()
	...
	ParticleEffect("vj_explosion1", self:GetPos(), defAngle, nil)
		...
		VJ_EmitSound(self,{"weapons/explode"..math.random(3,5)..".wav"},100,math.random(100,90))
