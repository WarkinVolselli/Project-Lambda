------------------ Addon Information ------------------
local PublicAddonName = "[VJ] Project Lambda"
local AddonName = "Project Lambda"
local AddonType = "NPC"
local AutorunFile = "autorun/vj_projectlambda_autorun.lua"
-------------------------------------------------------
...
if VJExists == true then
	...
	-- Precache models --
	util.PrecacheModel("models/vj_projectlambda/example_model.mdl")
	...
	*/  -- Comment box end
	...
	local vCat = "Project Lambda: Aliens"

	VJ.AddNPC("Floater", "npc_vj_projectlambda_floater", vCat)
